                ...
                <label class='form-label required'>Dasar Permintaan Data Pribadi</label>
                 <div class="d-flex align-items-center gap-2">
                    <div class="select-search" id="peranSelect">
                        <div class="d-flex align-items-center gap-2">
                            <input type="text" name="peranSelect" class="form-control" placeholder="Select Peran" data-value="" onblur="onBlur(this)">
                            <?php tooltip('test') ?>
                        </div>
...
<script>
        ...
        function populateTable(isFirstRender) {
            ...
            tableValue.filter((data)=> !data.isRender).forEach((data,index) => {
                ...
                cell1.innerHTML = `<input type="text" class="form-control" value="${data.jenisDataPribadi}">`;
                cell2.innerHTML = `<div class="select-search" id="sifatDataPribadi">
                                        <input type="text" class="form-control" placeholder="Select Sifat Data Pribadi" data-value="">
                                        <span class="select-clear">&times;</span>
                                        <div class="select-options">
                                            <div class="select-option" data-value="pt1" onclick="selectOption(this)">PT Maju Jaya</div>
                                            <div class="select-option" data-value="pt2" onclick="selectOption(this)">PT Sukses Makmur</div>
                ...
                if(!isFirstRender){
                    cell3.innerHTML = `<button key="${data.key}" class="btn btn-danger" onclick="deleteRow(this)">Delete</button>`;
                }   
        ...
        document.addEventListener('DOMContentLoaded', populateTable(true));
</script>